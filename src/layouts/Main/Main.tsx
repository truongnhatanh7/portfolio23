  ...
  return (
    <div className="p-12 grid grid-cols-2 h-screen items-center">
      <div className="flex flex-col gap-2">
        <h1 className="text-8xl text-left uppercase text-transparent bg-clip-text bg-gradient-to-r from-slate-900 to-transparent">
          NHAT ANH
        </h1>
        <h1 className="text-8xl text-left uppercase italic text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-400">
          Frontend Dev
        </h1>
      ...
      <div className="fixed -z-10 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-3/4 h-3/4 bg-gradient-to-r from-transparent to-slate-900 animate-[shapeShifting_7s_ease-in-out_infinite_alternate] scale-95">
      </div>
      <div className="fixed -z-10 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-3/4 h-3/4 bg-gradient-to-r from-transparent to-slate-900 animate-[shapeShifting_10s_ease-in-out_infinite_alternate] scale-90 rotate-3">
      </div>
    </div>
  )
}
